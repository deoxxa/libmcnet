...
#define ONLY_SERVER(code) if ((generator != NULL) && (generator->type == MCNET_TYPE_SERVER)) { code }
#define ONLY_CLIENT(code) if ((generator != NULL) && (generator->type == MCNET_TYPE_CLIENT)) { code }
